...
// Python AI Service Base URL - usually a FastAPI or Flask app
...
router.post('/generate', async (req, res) => {
  try {
    ...
    const response = await axios.post(`${PYTHON_AI_SERVICE_URL}/generate`, req.body);
    res.json(response.data);
  } catch (error: any) {
    console.error('[AI Proxy] Error calling Python AI service:', error.message);
