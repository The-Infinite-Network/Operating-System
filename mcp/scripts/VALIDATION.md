...
# GOOGLE_APPLICATION_CREDENTIALS=C:\keys\ie-mcp-drive.json
# GOOGLE_SHARED_DRIVE_ID=0AA9yG-ZObGxnUk9PVA
```
...
Test-Path C:\keys\ie-mcp-drive.json

# If false, create directory and place key file
New-Item -ItemType Directory -Force -Path C:\keys
# Then place your service-account-key.json file at C:\keys\ie-mcp-drive.json
```
...
Manifest:
{
  "sharedDriveId": "0AA9yG-ZObGxnUk9PVA",
