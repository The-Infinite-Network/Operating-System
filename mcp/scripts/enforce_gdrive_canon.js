...
const SHARED_DRIVE_ID = process.env.GOOGLE_SHARED_DRIVE_ID || "YOUR_SHARED_DRIVE_ID";
...
function getDriveId() {
  ...
  if (!driveId || driveId.trim() === "") {
    throw new Error(
      ...
      "Example: GOOGLE_SHARED_DRIVE_ID=YOUR_SHARED_DRIVE_ID"
    );
  }
  return driveId;
}
...
function getCredentialsPath() {
  ...
  // Windows paths like C:\keys\your-service-account.json work with resolve()
